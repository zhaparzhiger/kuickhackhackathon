                  ...
                  <CardContent>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="font-bold">124 views this week</p>
                      </div>

                      <div>
                        <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Network</h4>
                        <p className="font-bold">46 connections</p>
                      </div>
                    </div>
                ...
                <Card className="mt-6">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="outline" className="bg-secondary/5 hover:bg-secondary/10">
                        React
                      </Badge>
                      <Badge variant="outline" className="bg-secondary/5 hover:bg-secondary/10">
                        TypeScript
      ...
      <Dialog open={showPostModal} onOpenChange={setShowPostModal}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="space-y-4 py-4">
            <div>
              <label htmlFor="post-title" className="text-sm font-medium block mb-1">
                Title
              </label>
              <Input
                id="post-title"
                ...
                placeholder="e.g., Frontend Developer Resume - Seeking Feedback"
              />
            </div>

            <div>
              <label htmlFor="post-description" className="text-sm font-medium block mb-1">
                Description
              </label>
              <Textarea
                id="post-description"
                ...
                onChange={handlePostChange}
                placeholder="Tell others what kind of feedback you're looking for..."
                rows={3}
              />
            </div>

            <div>
              <label htmlFor="post-skills" className="text-sm font-medium block mb-1">
            ...
            <div>
              <label className="text-sm font-medium block mb-1">Upload Resume (PDF)</label>
              <div className="border-2 border-dashed rounded-lg p-4 text-center">
                {newPost.file ? (
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => setNewPost({ ...newPost, file: null })}>
                      Remove
                    </Button>
                  </div>
                ) : (
